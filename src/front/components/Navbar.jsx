      ...
      <div className="container d-flex justify-content-between align-items-center">
        ...
        <div className="d-flex align-items-center">
          <ul className="navbar-nav d-flex flex-row me-3">
            ...
            <li className="nav-item mx-2">
              <Link to="/products" className="nav-link text-white">Catálogo</Link>
            </li>
            <li className="nav-item mx-2">
              <Link to="/contact" className="nav-link text-white">Contacto</Link>
            </li>
            <li className="nav-item mx-2">
              <Link to="/sellos" className="nav-link text-white">Sellos</Link>
            </li>
            <li className="nav-item mx-2">
              <Link to="/tintas" className="nav-link text-white">Tintas</Link>
            </li>
          </ul>
